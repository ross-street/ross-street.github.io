...
\usepackage{amsthm,amscd,amssymb,amsmath,graphicx,verbatim,hyperref}
...
% These are the counters for the definition environment as currently set
...
% This is an alternative environment that counts by the section it's in instead of counting 1,2,3,4,... all throughout the paper.
% If you want to use this the comment out the counters and environment above and uncomment the below two lines. 
%\newenvironment{example}[1][Example]{\begin{trivlist}
%\item[\hskip \labelsep {\bfseries #1}]}{\end{trivlist}}
